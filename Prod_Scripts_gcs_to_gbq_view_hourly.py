...
cmnd= 'gsutil cp gs://mattel_thoughtspot/table_list/views_new_hourly.xlsx '+VM_path+'views_hourly.xlsx'
os.system(cmnd)

wb = xlrd.open_workbook(VM_path+"views_hourly.xlsx")
...
cmd4= 'ssh thoughtspot@10.138.0.5 gsutil -m rsync gs://mattel_thoughtspot/hourly /tsfilestore/files/data/falcon_default_schema'
os.system(cmd4)

cmd9= 'ssh thoughtspot@10.138.0.5 gsutil -m mv gs://mattel_thoughtspot/stage_done /tsfilestore/files/data/stage_done'
os.system(cmd9)

cmd8 = 'gsutil mv '+path+'* '+archive
os.system(cmd8)

os.system('rm '+VM_path+'views_hourly.xlsx')
