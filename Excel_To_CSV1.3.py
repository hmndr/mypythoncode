...
bucket_path = 'gs://my_bucket07/'

Archive_path = 'gs://my_bucket07/Archive1/'

VM_path = '//home/hmndrpratap/testdata/'
...
if "asia" in Excel_File_Name.lower():
    ...
    cmd4='gsutil mv '+bucket_path+Excel_File_Name+' '+bucket_path+File_Name[0]+'_'+Date[0]+'_'+Date[1]+'_'+Date[2]+'.'+File_Name[1]
    os.system(cmd4)

    cmd5='mv '+VM_path+Excel_File_Name+' '+VM_path+File_Name[0]+'_'+Date[0]+'_'+Date[1]+'_'+Date[2]+'.'+File_Name[1]
    os.system(cmd5)


    Excel_File_Name=File_Name[0]+'_'+Date[0]+'_'+Date[1]+'_'+Date[2]+'.'+File_Name[1]
